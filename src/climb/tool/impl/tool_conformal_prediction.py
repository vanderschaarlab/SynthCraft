...
def conformal_prediction_function(
    ...
    if task_type.lower() == 'classification':
        ...
        clf = MapieClassifier(estimator=wrapped_model, cv="prefit", method="score")
        ...
        tc.set_returns(
            tool_return=(
                f"The conformal prediction model has been trained and predictions have been made on the test set."
            ),
            user_report=[
        ...
        reg = MapieRegressor(estimator=wrapped_model, cv="prefit", method="plus")
        ...
        df_train['binary_event'] = (df_train[time_to_event_column] <= 
                                    df_train[df_train[target_column] == 1][time_to_event_column].median()).astype(int)
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "alpha": {
                            "type": "number",
                            "description": "Miscoverage level (e.g., 0.1 for 90% coverage)."
                        }
                    },
                    "required": ["model_file_path", "train_data_file_path", "test_data_file_path", "task_type", "target_column"]
                }
            }
        }
