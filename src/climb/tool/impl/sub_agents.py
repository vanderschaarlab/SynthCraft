...
def create_llm_client(
    ...
    if session.engine_name in ("openai", "openai_nextgen", "openai_min_baseline", "openai_nextgen_sim", "openai_cot"):
        client = OpenAI(api_key=additional_kwargs_required["api_key"])
    elif session.engine_name in ("azure_openai", "azure_openai_nextgen", "azure_openai_min_baseline", "azure_openai_nextgen_sim", "azure_openai_cot"):
        client = AzureOpenAI(
...
def get_llm_chat(
    ...
    if session.engine_name in ("openai", "openai_nextgen", "openai_cot"):
    ...
    elif session.engine_name in ("azure_openai", "azure_openai_nextgen", "azure_openai_cot"):
