...
Welcome to `climb-ai` contributor's guide.
...
If you experience bugs or general issues with `climb-ai`, please have a look
...
You can help improve `climb-ai` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`climb-ai` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `climb-ai`'s files. While this mechanism can
...
```
conda create -n climb-ai python=3 six virtualenv pytest pytest-cov
conda activate climb-ai
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/climb-ai.git
   cd climb-ai
   ```
...
5. Install [pre-commit]:
   ...
   `climb-ai` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/climb-ai
[issue tracker]: https://github.com/<USERNAME>/climb-ai/issues
